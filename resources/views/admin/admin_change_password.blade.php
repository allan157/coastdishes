                        ...
                        <div class="col-lg-6">
                            <div>
                                ...
                                <div class="mb-3">
                                    ...
                                    is-invalid @enderror" name="new_password" type="password" id="new_password">
                                    @error('new_password')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <button type="button" type="submit" class="btn btn-primary waves-effect waves-light">Save Changes</button>
